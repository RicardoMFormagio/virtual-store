...
public interface IProductService
{
    ...
    Task<ProductViewModel> CreateProduct(ProductViewModel productVMRequest, string token);
    Task<ProductViewModel> UpdateProduct(ProductViewModel productVMRequest, string token);
